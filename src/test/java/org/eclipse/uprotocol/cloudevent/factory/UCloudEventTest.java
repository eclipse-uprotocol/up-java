...
/* 
    ...
    public void test_extract_source_from_cloudevent() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest();
    ...
    public void test_extract_sink_from_cloudevent_when_sink_exists() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("sink", URI.create(sinkForTest));
    ...
    public void test_extract_requestId_from_cloudevent_when_requestId_exists() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("reqid", "someRequestId");
    ...
    public void test_extract_requestId_from_cloudevent_when_requestId_value_is_null() {
        String reqid = null;
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("reqid", reqid);
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_extract_hash_from_cloudevent_when_hash_does_not_exist() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withoutExtension("hash");
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_extract_priority_from_cloudevent_when_priority_does_not_exist() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withoutExtension("priority");
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_extract_ttl_from_cloudevent_when_ttl_does_not_exist() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withoutExtension("ttl");
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_extract_token_from_cloudevent_when_token_does_not_exist() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withoutExtension("token");
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_cloudevent_has_platform_error_when_platform_error_exists() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("commstatus", UCode.ABORTED_VALUE);
    ...
    public void test_extract_platform_error_from_cloudevent_when_platform_error_exists_in_wrong_format() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("commstatus", "boom");
    ...
    public void test_extract_platform_error_from_cloudevent_when_platform_error_exists() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("commstatus",
    ...
    public void test_extract_creation_timestamp_from_cloudevent_UUIDV8_Id_when_UUIDV8_id_is_valid() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withId(str_uuid);
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_cloudevent_is_not_expired_cd_when_ttl_is_zero() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("ttl", 0);
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isExpiredByCloudEventCreationDate(cloudEvent));
    }
    ...
    public void test_cloudevent_is_not_expired_cd_when_ttl_is_minus_one() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("ttl", -1);
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isExpiredByCloudEventCreationDate(cloudEvent));
    }
    ...
    public void test_cloudevent_is_not_expired_cd_when_ttl_3_mili_no_creation_date() {
        ...
        final CloudEvent.Builder builder = CloudEventBuilder.v1().withId("id").withType("pub.v1")
    ...
    public void test_cloudevent_is_not_expired_cd_when_ttl_500_mili_with_creation_date_of_now() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withTime(OffsetDateTime.now())
                .withExtension("ttl", 500);
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isExpiredByCloudEventCreationDate(cloudEvent));
    }
    ...
    public void test_cloudevent_is_expired_cd_when_ttl_500_mili_with_creation_date_of_yesterday() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withTime(yesterday).withExtension("ttl", 500);
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_cloudevent_is_not_expired_cd_when_ttl_500_mili_with_creation_date_of_tomorrow() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withTime(tomorrow).withExtension("ttl", 500);
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isExpiredByCloudEventCreationDate(cloudEvent));
    }
    ...
    public void test_cloudevent_is_not_expired_when_no_ttl_configured() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withoutExtension("ttl").withId(str_uuid);
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_cloudevent_is_not_expired_when_ttl_is_zero() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("ttl", 0).withId(str_uuid);
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isExpired(cloudEvent));
    }
    ...
    public void test_cloudevent_is_not_expired_when_ttl_is_minus_one() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("ttl", -1).withId(str_uuid);
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isExpired(cloudEvent));
    }
    ...
    public void test_cloudevent_is_not_expired_when_ttl_is_large_number_mili() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("ttl", Integer.MAX_VALUE)
                .withId(str_uuid);
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isExpired(cloudEvent));
    }
    ...
    public void test_cloudevent_is_expired_for_invalid_uuid() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("ttl", 50000).withId("");
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isExpired(cloudEvent));
    }
    ...
    public void test_cloudevent_does_not_have_a_UUIDV8_id() {
        ...
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("ttl", 3).withId(str_uuid);
        CloudEvent cloudEvent = builder.build();
    ...
    public void test_cloudevent_does_not_have_a_UUID_id_just_some_string() {
        CloudEvent.Builder builder = buildBaseCloudEventBuilderForTest().withExtension("ttl", 3);
        CloudEvent cloudEvent = builder.build();
        assertFalse(UCloudEvent.isCloudEventId(cloudEvent));
    }
    ...
    public void test_extractPayload_from_cloud_event_as_any_proto_object() {
        ...
        final CloudEvent.Builder  cloudEventBuilder = CloudEventBuilder.v1().withId("someId").withType("pub.v1")
    ...
    public void test_umessage_has_platform_error_when_platform_error_exists() {
        ...
        final CloudEvent.Builder cloudEventBuilder =
                ...
                protoPayload, uCloudEventAttributes);
        cloudEventBuilder.setType(UCloudEvent.getEventType(UMessageType.UMESSAGE_TYPE_PUBLISH))
        cloudEventBuilder.putAttributes("commstatus", CloudEventAttributeValue.newBuilder().setCeInteger(UCode.ABORTED_VALUE).build())
        cloudEventBuilder.putAttributes("plevel", CloudEventAttributeValue.newBuilder().setCeInteger(2).build())
