...
public interface RpcServer {
     ...
     */
    CompletionStage<Void> registerRequestHandler(UUri method, RequestHandler handler);
     ...
     */
    CompletionStage<Void> unregisterRequestHandler(UUri method, RequestHandler handler);   
}
