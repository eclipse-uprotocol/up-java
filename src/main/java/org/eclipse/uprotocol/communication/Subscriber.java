...
public interface Subscriber {
     ...
     */
    CompletionStage<Void> unsubscribe(UUri topic, UListener listener, CallOptions options);
     ...
     */
    CompletionStage<Void> unregisterListener(UUri topic, UListener listener);
}