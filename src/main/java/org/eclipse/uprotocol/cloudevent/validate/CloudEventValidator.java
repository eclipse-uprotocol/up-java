...
public abstract class CloudEventValidator {
    ...
    /**
     * Validate the CloudEvent. A CloudEventValidator instance is obtained according to the 
     * type attribute on the CloudEvent.
     * 
     * @param cloudEvent The CloudEvent to validate.
     * @return Returns a google.rpc.Status with success or a google.rpc.Status with failure containing
    ...
    private static class Publish extends CloudEventValidator {
        ...
        public ValidationResult validateSource(CloudEvent cloudEvent) {
            ...
            return UriValidator.isTopic(UriSerializer.deserialize(source)) ? 
                ValidationResult.success() : ValidationResult.failure(
        ...
        public ValidationResult validateSink(CloudEvent cloudEvent) {
            return UCloudEvent.getSink(cloudEvent).isPresent() ? 
                ValidationResult.failure("Publish should not have a sink") : ValidationResult.success();
        }
    }
    ...
    private static class Request extends CloudEventValidator {
        ...
        public ValidationResult validateSource(CloudEvent cloudEvent) {
            final String source = cloudEvent.getSource().toString();
            return UriValidator.isRpcResponse(UriSerializer.deserialize(source)) ? 
                ValidationResult.success() : ValidationResult.failure(
        ...
        public ValidationResult validateSink(CloudEvent cloudEvent) {
            ...
            return UriValidator.isRpcMethod(UriSerializer.deserialize(sink.get())) ? 
                ValidationResult.success() : ValidationResult.failure(
    ...
    private static class Response extends CloudEventValidator {
        ...
        public ValidationResult validateSource(CloudEvent cloudEvent) {
            final String source = cloudEvent.getSource().toString();
            return UriValidator.isRpcMethod(UriSerializer.deserialize(source)) ? 
                ValidationResult.success() : ValidationResult.failure(
        ...
        public ValidationResult validateSink(CloudEvent cloudEvent) {
            ...
            return UriValidator.isRpcResponse(UriSerializer.deserialize(sink.get())) ? 
                ValidationResult.success() : ValidationResult.failure(
